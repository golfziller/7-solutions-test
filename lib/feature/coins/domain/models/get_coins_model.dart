...
part 'get_coins_model.freezed.dart';
part 'get_coins_model.g.dart';

@freezed
abstract class GetCoins with _$GetCoins {
  @JsonSerializable()
  const factory GetCoins({
    @JsonKey(name: 'data') required CoinData data,
    @JsonKey(name: 'pagination') required Pagination pagination,
  }) = _GetCoins;

  factory GetCoins.fromJson(Map<String, dynamic> json) =>
